...
class QuerySolution:
    ...
    generated_graph: str = 'False'
    passage_nodes_on_path: Optional[List[str]] = None
    ...
    def __init__(self, question,
        ...
        self.passage_nodes_on_path = passage_nodes_on_path

    def to_dict(self):
        if self.passage_nodes_on_path:
            passage_nodes_on_path = self.passage_nodes_on_path
        else:
        ...
        return {
            ...
            "docs": self.docs[:5] + passage_nodes_on_path,
